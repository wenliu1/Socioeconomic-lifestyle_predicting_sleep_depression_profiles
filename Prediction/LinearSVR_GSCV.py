...
class linearSVR:
    ...
    # Define models and their parameter grids
        self.models_dict = {
            ...
            'LinearSVR': (
            LinearSVR(random_state=42, max_iter=20000, loss='squared_epsilon_insensitive', dual=False),
            {
    ...
    def LinearSVR_tuning(self, pipeline, Features_train, target_train, Features_test, target_test, 
