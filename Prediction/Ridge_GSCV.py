...
class ridge:
    ...
    def Ridge_tuning(self, pipeline, Features_train, target_train, Features_test, target_test, 
                     models_dict, Inner_cv, i, eid_test, save_path=None, model_save_dir=None, n_jobs=-1):
        """
        ...
        def evaluate_model(model_name, model_tuple):
            ...
            # Get best model and pipeline
            best_model = grid_search.best_estimator_

            # Save the full pipeline to the specified directory
            if model_save_dir:  # Only save if directory is provided
