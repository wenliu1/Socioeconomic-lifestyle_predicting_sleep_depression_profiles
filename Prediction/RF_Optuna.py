...
class RF:
    ...
    def objective(self, trial, pipeline, Features_train, target_train, Features_test, target_test, model_name, model):
        ...
        for step, (train_idx, val_idx) in enumerate(kf.split(Features_train)):
            ...
            current_model = RandomForestRegressor(**params) 

            # Rebuild the pipeline without the model step
    ...
    def RF_tuning(self, pipeline, Features_train, target_train, Features_test, target_test, 
                  models_dict, Inner_cv, i, eid_test, save_path=None, pipeline_save_path=None, RF_n_jobs=1, n_jobs=1):
        """
        ...
        def evaluate_model(model_name, model_tuple):
            ...
            study.optimize(
                ...
                n_jobs=RF_n_jobs # Optuna-specific parallelism
            )
