...
class lasso:
    ...
    # Define models and their parameter grids
        self.models_dict = {
            # Add SVR with RBF kernel
            'Lasso': (
            Lasso(random_state=42),
            {'alpha': np.logspace(-4, 2, 10)}
        )}

    def Lasso_tuning(self, pipeline, Features_train, target_train, Features_test, target_test, 
        ...
        # Appending the metrics if file exists
        if save_path:
            ...
            if os.path.exists(predictions_path):
                try:
                    ...
                    if os.path.getsize(predictions_path) > 0:
                        ...
                        # File exists but is empty, just write new predictions
